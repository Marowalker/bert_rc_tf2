...
train_x_ref_path = RAW_PROCESSED + 'raw_sdp_ref.train.txt'
train_x_path = RAW_PROCESSED + 'raw_sdp.train.txt'
...
train_y_path = RAW_PROCESSED + 'raw_label.train.txt'
...
test_x_ref_path = RAW_PROCESSED + 'raw_sdp_ref.test.txt'
test_x_path = RAW_PROCESSED + 'raw_sdp.test.txt'
...
test_y_path = RAW_PROCESSED + 'raw_label.test.txt'
